...
export const COMMON_OAUTH2_PATH_PREFIX = '/oauth2';

export const PORTAL_PATH_PREFIX = '/api/portal';
export const PORTAL_FORUM_PATH_PREFIX = '/forum';
export const PORTAL_ANNOUNCE_PATH_PREFIX = '/announce';
